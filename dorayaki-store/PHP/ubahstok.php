...
<head>
    ...
    <link rel="stylesheet" href="../CSS/style-ubahstok.css">
        ...
        <div class="bungkus">
            <!-- <div class="box-container">
                ...
                <div class="box-container-slidedetail">
                    <div class="text">
                        <h2>Dorayakan</h2>
                        <p>Dorayaki Cokelat</p>
                        <p class="price">Rp 5.000</p>
                    </div>
                    <div class="text-bottom">
                        <p style="padding:10px;"></p>
                        <p class="stok">Ubah Stok</p>
                        <div class="btn-admin">
                            <button onClick="" id="min" class="ubah">-</button>
                            <button onClick="" id="plus" class="hapus">+</button>
                        </div>
                        <p class="stok">Tambahkan Stok : 5</p>
...
<script src="../JS/ubahstok.js"></script>
