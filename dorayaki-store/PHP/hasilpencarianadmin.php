...
<head>
    ...
    <link rel="stylesheet" href="../CSS/style-hasilpencarian.css">
...
<body>
    ...
    <div class="pagination">
        <button onclick="prevpage()" class="pagination-btn" id="left">
            <i class="fas fa-arrow-left"></i>
        </button>
        <p class="pagination-pagenum"></p>
        <button onclick="nextpage()" class="pagination-btn" id="right">
...
<script src="../JS/getsearchproductadmin.js"></script>
